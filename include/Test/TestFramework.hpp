...
#define TEST_CASE(name) \
    ...
    static FoundationKit::Test::TestCase test_case_##name = { #name, test_func_##name, nullptr }; \
    static FoundationKit::Test::TestRegistrar test_registrar_##name(&test_case_##name); \
    static void test_func_##name()

#define ASSERT_TRUE(expr) \
    if (!(expr)) { \
        FoundationKit::Test::TestRegistry::ReportFailure(#expr, __FILE__, __LINE__); \
        FoundationKit::Test::TestRegistry::SetCurrentTestFailed(); \
        return; \
    }
