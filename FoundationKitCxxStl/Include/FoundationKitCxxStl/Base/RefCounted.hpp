...
namespace FoundationKitCxxStl {
    ...
    public:
        ...
        [[nodiscard]] bool ReleaseRef() const noexcept {
            FK_BUG_ON(m_ref_count.Load(Sync::MemoryOrder::Relaxed) == 0, 
                "RefCountedBase: Double free or underflow");
        ...
        [[nodiscard]] u32 GetRefCount() const noexcept {
            return m_ref_count.Load(Sync::MemoryOrder::Acquire);
        }
