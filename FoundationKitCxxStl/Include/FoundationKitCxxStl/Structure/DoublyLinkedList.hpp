    ...
    public:
        struct Node {
            ...
            Node(Node* p, Node* n, Args&&... args)
                : value(FoundationKitCxxStl::Forward<Args>(args)...), next(n), prev(p) {}
        };
        ...
        DoublyLinkedList(DoublyLinkedList&& other) noexcept
            : m_allocator(FoundationKitCxxStl::Move(other.m_allocator)), m_head(other.m_head), m_tail(other.m_tail), m_size(other.m_size) {
        ...
        bool PushFront(Args&&... args) {
            ...
            auto* new_node = FoundationKitCxxStl::ConstructAt<Node>(res.ptr, nullptr, m_head, FoundationKitCxxStl::Forward<Args>(args)...);
            if (m_head) {
        ...
        bool PushBack(Args&&... args) {
            ...
            auto* new_node = FoundationKitCxxStl::ConstructAt<Node>(res.ptr, m_tail, nullptr, FoundationKitCxxStl::Forward<Args>(args)...);
            if (m_tail) {
